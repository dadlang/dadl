...
// type justValueParser struct {
// 	valueType valueType
// }

// func (p *justValueParser) parse(ctx *parseContext, value string) error {
// 	// println("[simpleValueParser.parse]", value)

// 	var builder valueBuilder
// 	err := p.valueType.parse(builder, value)
// 	if err != nil {
// 		return err
// 	}
// 	ctx.lastBuilder = builder
// 	ctx.lastSchema = ctx.parentSchema
// 	return nil
// }

// func (p *justValueParser) childParser() (NodeParser, error) {
// 	return nil, nil
// }
